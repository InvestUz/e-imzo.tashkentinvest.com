...
var EIMZOClient = {
    ...
    createPkcs7Base64: function (id, data, timestamper, success, fail) {
        CAPIWS.callFunction({ plugin: "pkcs7", name: "create_pkcs7", arguments: [data, id, 'no'] }, function (event, data) {
            if (data.success) {
                var pkcs7 = data.pkcs7_64;
                if (timestamper) {
                    var sn = data.signer_serial_number;
    ...
    createPkcs7Mod: function (id, data, success, fail) {
        CAPIWS.callFunction({ plugin: "pkcs7", name: "create_pkcs7", arguments: [Base64.encode(data), id, 'no'] }, function (event, data) {
            if (data.success) {
                success(data.pkcs7_64, data.signer_serial_number, data.signature_hex);
            } else {
                fail(null, data.reason);
            }
        }, function (e) {
    ...
    createPkcs7Base64Mod: function (id, data, success, fail) {
        CAPIWS.callFunction({ plugin: "pkcs7", name: "create_pkcs7", arguments: [data, id, 'no'] }, function (event, data) {
            if (data.success) {
                success(data.pkcs7_64, data.signer_serial_number, data.signature_hex);
            } else {
    ...
    appendPkcs7Mod: function (id, data, success, fail) {
        CAPIWS.callFunction({ plugin: "pkcs7", name: "append_pkcs7_attached", arguments: [data, id] }, function (event, data) {
            if (data.success) {
                success(data.pkcs7_64, data.signer_serial_number, data.signature_hex);
            } else {
    ...
    attachTimestampTokenPkcs7Mod: function (data, serialNumber, timestampToken, success, fail) {
        CAPIWS.callFunction({ plugin: "pkcs7", name: "attach_timestamp_token_pkcs7", arguments: [data, serialNumber, timestampToken] }, function (event, data) {
            if (data.success) {
